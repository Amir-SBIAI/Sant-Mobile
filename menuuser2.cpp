...
MenuUser2::MenuUser2(QWidget *parent)
    : QWidget(parent)
{
    // Création du titre
    QLabel *titre = new QLabel("Menu Surveillance Kader.Mastif", this);
    ...
    setLayout(layout);
    setWindowTitle("Menu Utilisateur 2");
    resize(500, 400);

    connect(boutonAffichage, &QPushButton::clicked, this, &MenuUser2::ouvrirPageAffichage);
    connect(boutonHistorique, &QPushButton::clicked, this, &MenuUser2::ouvrirPageHistorique);
    connect(boutonAlerte, &QPushButton::clicked, this, &MenuUser2::envoyerAlerte);
    ...
    connect(boutonDeconnexion, &QPushButton::clicked, this, &MenuUser2::deconnecterUtilisateur);
    ...
    connect(timer, &QTimer::timeout, this, &MenuUser2::verifierReponse);
    connect(socket, &QTcpSocket::readyRead, this, &MenuUser2::verifierReponse);
}
...
void MenuUser2::envoyerAlerte()
{
    QString codeAleatoire = genererCodeAleatoire();
    QString trame = "V;" + codeAleatoire + ";[2];$";
...
void MenuUser2::verifierReponse()
{
...
void MenuUser2::ouvrirPageAffichage()
{
    qDebug() << "Ouverture de la page d'affichage des mesures...";
    PageAffichage *page = new PageAffichage("user2");
...
void MenuUser2::ouvrirPageHistorique()
{
    qDebug() << "Ouverture de la page d'historique des mesures...";
    PageHistorique *page = new PageHistorique("user2");
    page->setAttribute(Qt::WA_DeleteOnClose);
    page->show();
    this->close();
}

void MenuUser2::deconnecterUtilisateur()
{
...
QString MenuUser2::genererCodeAleatoire()
{
